...
def testcase():
    hexadecimal = open(os.path.join(os.path.dirname(__file__), "day-16-test.txt")).read()
...
if __name__ == "__main__":
    ...
    hexadecimal = open(os.path.join(os.path.dirname(__file__), "day-16-input.txt")).read()
