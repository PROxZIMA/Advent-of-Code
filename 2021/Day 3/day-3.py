...
def testcase():
    diagnostic_report = open(os.path.join(os.path.dirname(__file__), "day-3-test.txt")).read()
...
if __name__ == "__main__":
    ...
    diagnostic_report = open(os.path.join(os.path.dirname(__file__), "day-3-input.txt")).read()
    diagnostic_report = diagnostic_report.split('\n')
