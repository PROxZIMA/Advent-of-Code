...
def testcase():
    target_area = open(os.path.join(os.path.dirname(__file__), "day-17-test.txt")).read()
...
if __name__ == "__main__":
    ...
    target_area = open(os.path.join(os.path.dirname(__file__), "day-17-input.txt")).read()
