    ...
    def printAllPathsUtil(self, u, desti, visited, visit_twice, visit_small):
        ...
        for i in self.graph[u]:
            ...
            if i.isupper() or (i not in new_visited):
                self.paths_count += self.printAllPathsUtil(i, desti, new_visited, visit_twice, visit_small)

            elif visit_twice and not visit_small and (i in new_visited) and new_visited[i] < 2:
                self.paths_count += self.printAllPathsUtil(i, desti, new_visited, visit_twice, True)
